...
export default function About() {
    return (
        <main className="bg-white overflow-hidden">
            ...
            <BlogFormat title="About" description="A filler blog post to display the blog format. Going to write out a good amount of blogs when I find the time." date="December 23, 2024" author="Anand Tandon" components={components} />
